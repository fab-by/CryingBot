      ...
      .send({
        embeds: [
          new discord.MessageEmbed()
            ...
            .setFooter({ text: "Powered by crying.tk" })
            .setDescription(
              `${message.client.emoji.success} | ${language.applaydone} **${message.guild.name}** [by clicking here](http://bot.crying.tk/apply/${message.guild.id})`
            ),
        ],
      })
