...
window.onload = () => {
  ...
  let editorHolder = document.querySelector(".editorHolder"),
    ...
    json = {
      ...
      embed: {
        title: "Hello! :wave:",
        description:
          "You can use [links](http://bot.crying.tk) or emojis :smile: :eyes:\n```\nAnd also code blocks\n```",
        color: 4321431,
        timestamp: new Date().toISOString(),
        url: "http://bot.crying.tk",
        author: {
          name: "Author name",
          url: "http://bot.crying.tk",
  ...
  $(document).on("click", "#save-custom", function (e) {
    ...
    error(
      'Successfully saved command, if not saved, <a href="http://bot.crying.tk/embeds">read here</a>',
      10000
    );
    e.preventDefault();
    $.ajax({
