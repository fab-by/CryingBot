...
module.exports = async (client) => {
      ...
      member
        .sendCustom({
          embeds: [
            new MessageEmbed()
              .setColor("GREEN")
              .setFooter({ text: `Powered by http://bot.crying.tk` })
  ...
  app.get("/dashboard/:guildID", checkAuth, async (req, res) => {
    ...
    renderTemplate(res, req, "./new/mainpage.ejs", {
      guild: guild,
      alert: `Dashboard was made by http://bot.crying.tk`,
...
In the mean time, please explain your issue below`;
    ...
    if (Object.prototype.hasOwnProperty.call(data, "sendEmbed")) {
      ...
      if (ticketSettings.ticketToggle == "true") {
        if (
          ...
          if (storedSettings.isPremium == "false") {
            ticketSettings.ticketFooter = "Powered by crying.tk";
          } else {
          ...
          let reactionFooter = "Powered by crying.tk";

          let footer = "Powered by crying.tk";
          // eslint-disable-next-line no-unused-vars
          ...
          if (storedSettings.isPremium == "false") {
            ticketEmbed.setFooter({ text: `Powered by crying.tk` });
          } else {
            if (checkFooter) {
  ...
  app.post("/dblwebhook", webhook.middleware(), async (req) => {
    ...
    const msg = new Discord.MessageEmbed()
      ...
      .setDescription(
        `Thank you **${apiUser.username}#${apiUser.discriminator}** (${apiUser.id}) for voting **Crying**!`
      );
    Hook.sendCustom(msg);
